...
import 'package:obs/sayfalar/ogretim_uyesi_gorevlisi_ders_listesi_ekrani.dart';
import 'package:obs/sayfalar/ogretim_uyesi_gorevlisi_notlar_ekrani.dart';
import 'package:obs/sayfalar/uygulama_hakkinda_ekrani.dart';
import 'package:obs/sayfalar/yemek_listesi_ekrani.dart';

class OgretimUyesiGorevlisiGecisEkrani extends StatefulWidget {
  ...
  OgretimUyesiGorevlisiGecisEkrani({Key? key,
    required this.kisiAdSoyad,
    required this.kisiUnvan,
    required this.kisiId,required this.kisiKimlikNo,
    required this.kisiSayac,required this.kisiSifre,required this.kisiProfilResim})
      : super(key: key);

  @override
  State<OgretimUyesiGorevlisiGecisEkrani> createState() => _OgretimUyesiGorevlisiGecisEkraniState();
}

class _OgretimUyesiGorevlisiGecisEkraniState extends State<OgretimUyesiGorevlisiGecisEkrani> {
    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      ListTile(
                        leading: Sabitler.GecisEkraniDrawerListTileIcon(Icons.grade_rounded,
                            Colors.teal),
                        title: Sabitler.GecisEkraniDrawerListTileBaslik("Öğrenci Notları"),
                        shape: RoundedRectangleBorder(
                          borderRadius: Sabitler.gecisEkraniDrawerListTileBorderRadius,
                        ),
                        onTap: (){
      ...
      body: WillPopScope(
        ...
        child: PageView(
          ...
          children: [
            OgretimUyesiGorevlisiDersListesiEkrani(
              kisiId: widget.kisiId,kisiKimlikNo: widget.kisiKimlikNo,
            ),
            const OgretimUyesiGorevlisiNotlarEkrani(),
